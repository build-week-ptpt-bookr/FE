  ...
  return (
    <div>
      <p>
        ...
        related to it, still belong to Best Bookr PTPTBW1 Team @ Lambda. ​ Best
        Bookr PTPTBW1 Team @ Lambda is committed to ensuring that the app is as
        ...
        The Best Bookr app stores and processes personal data that you have
        ...
        phone’s security features and it could mean that the Best Bookr app
        won’t work properly or at all. ​ You should be aware that there are
        certain things that Best Bookr PTPTBW1 Team @ Lambda will not take
        ...
        provided by your mobile network provider, but Best Bookr PTPTBW1 Team @
        Lambda cannot take responsibility for the app not working at full
        functionality if you don’t have access to Wi-Fi, and you don’t have any
        of your data allowance left. ​ If you’re using the app outside of an
        ...
        the bill payer for using the app. ​ Along the same lines, Best Bookr
        PTPTBW1 Team @ Lambda cannot always take responsibility for the way you
        use the app i.e. You need to make sure that your device stays charged –
        if it runs out of battery and you can’t turn it on to avail the Service,
        Best Bookr PTPTBW1 Team @ Lambda cannot accept responsibility. ​ With
        respect to Best Bookr PTPTBW1 Team @ Lambda’s responsibility for your
        use of the app, when you’re using the app, it’s important to bear in
        mind that although we endeavour to ensure that it is updated and correct
        at all times, we do rely on third parties to provide information to us
        so that we can make it available to you. Best Bookr PTPTBW1 Team @
        Lambda accepts no liability for any loss, direct or indirect, you
        experience as a result of relying wholly on this functionality of the
        app. ​ At some point, we may wish to update the app. The app is
        currently available on iOS – the requirements for system (and for any
        ...
        using the app. Best Bookr PTPTBW1 Team @ Lambda does not promise that it
        will always update the app so that it is relevant to you and/or works
        with the iOS version that you have installed on your device. However,
        ...
        and (if needed) delete it from your device. ​ Changes to This Terms and
        ...
        Conditions on this page. These changes are effective immediately after
        they are posted on this page. ​ Contact Us ​ If you have any questions
        or suggestions about our Terms and Conditions, do not hesitate to
        contact us at bestbookrteamptptbw@cuatrotresdos.uno.
      </p>
    </div>
  );
}
